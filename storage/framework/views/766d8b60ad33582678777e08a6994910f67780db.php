...
<?php $component->withAttributes([]); ?>
         <?php $__env->slot('logo', null, []); ?> 
            <a href="/">
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.logo','data' => ['class' => 'w-20 h-20']]); ?>
...
<?php endif; ?>
            ...
            <div class="block mt-4">
                <label for="remember_me" class="inline-flex items-center">
                    <input id="remember_me" type="checkbox" class="border-2 border-gray-300 text-red-500 shadow-sm checked:border-red-500 focus:ring focus:ring-red-400" name="remember">
            ...
            <div class="flex items-center justify-end mt-4">
                <?php if(Route::has('password.request')): ?>
                    <a class="underline text-sm" href="<?php echo e(route('password.request')); ?>">
...
<?php endif; ?>
<?php /**PATH D:\PhpProjects\tz-domain\resources\views/auth/login.blade.php ENDPATH**/ ?>